...
const defaultOwner = '923276792734';
...
//
global.botname = process.env.BOTNAME || 'IMRAN-SaLaRa';
global.pairingNumber = process.env.BOT_NUMBER || '923276792734';  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'session id';  // put your session id here

global.mods = []
global.prems = []
global.allowed = ['923276792734', '923276792734']
